...
# EFS File System ID Outputs
output "efs_file_system_id" { value = aws_efs_file_system.efs_file_system.id }
output "efs_file_system_dns_name" { value = aws_efs_file_system.efs_file_system.dns_name }
# EFS Mounts Info Outputs
output "efs_mount_target_id" { value = aws_efs_mount_target.efs_mount_target[*].id }
output "efs_mount_target_dns_name" { value = aws_efs_mount_target.efs_mount_target[*].mount_target_dns_name }
output "efs_mount_target_availability_zone_name" { value = aws_efs_mount_target.efs_mount_target[*].availability_zone_name }